...
export function renderAudioBufferLoaderService(options, $container) {
  render(html`
    <div class="screen">
      ...
      <section class="half-screen aligner services">
        <div>
          <ul>
            ...
            <li class="normal initialization-item">loading audio files<span>.</span><span>.</span><span>.</span></li>
          </ul>
        </div>
      </section>
    </div>
...
export function renderErroredAudioBufferLoaderService(options, $container) {
  render(html`
    <div class="screen">
      <section class="half-screen aligner">
        <div class="align-center">
      ...
      <section class="half-screen aligner services">
        <div>
          <ul>
            ...
            <li class="normal error-item">loading audio files</li>
          </ul>
        </div>
      </section>
    </div>
